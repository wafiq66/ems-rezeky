...
public class AttendanceDAOImpl implements AttendanceDAO{
    ...
    public Attendance[] getAllAttendancesByBranch(Branch branch, int month, int year) {
        ...
        String sql = "SELECT A.ATTENDANCEID, " +
                     ...
                     "       DATE_FORMAT(A.CLOCKINTIME, '%H:%i:%s') AS CLOCKINTIME, " +
                     "       DATE_FORMAT(A.CLOCKOUTTIME, '%H:%i:%s') AS CLOCKOUTTIME " +
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                if (resultSet.next()) {
                    ...
                    attendance = new Attendance(
                        resultSet.getInt("ATTENDANCEID"),
                        attendanceDate != null ? attendanceDate : "none",
                        clockInTime != null ? clockInTime : "none",
                        clockOutTime != null ? clockOutTime : "none"
                    );
                } else {
