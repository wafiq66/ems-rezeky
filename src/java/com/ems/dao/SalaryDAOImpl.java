...
public class SalaryDAOImpl implements SalaryDAO {
    ...
    public Salary[] getUncalculatedEmployeeSalary(int month, int year) {
        ...
        String sql = "SELECT " +
                     ...
                     "TotalHoursWorked, " +
                     "TotalSalary " +
                     "FROM uncalculatesalary " +
                     "WHERE AttendanceMonth = ? AND AttendanceYear = ?";
    ...
    public Salary getUncalculatedEmployeeSalary(Employee employee, int month, int year) {
        ...
        String sql = "SELECT " +
                     ...
                     "TotalSalary " +
                     "FROM uncalculatesalary " +
                     "WHERE EmployeeID = ? AND AttendanceMonth = ? AND AttendanceYear = ?";
    ...
    public Salary[] getUncalculatedEmployeeSalary(Employee employee) {
        ...
        String sql = "SELECT " +
                     ...
                     "FROM uncalculatesalary " +
                     "WHERE EmployeeID = ? " +
                     "ORDER BY AttendanceYear, AttendanceMonth, EmployeeID";
